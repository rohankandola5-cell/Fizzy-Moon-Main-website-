        ...
        <>
          ...
          >
            <div 
              ...
              style={{ 
                backgroundColor: config.backgroundColor || '#15222e',
            ...
            >
                ...
                <div className="relative w-full h-full overflow-hidden rounded-2xl border border-white/10 shadow-2xl">
                  ...
                  {(config.title || config.subtitle || config.ctaText) && (
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-6 md:p-8">
                      ...
                      {config.subtitle && (
                        <p className="text-lg md:text-xl text-[#f78e2c] font-medium mb-6">
                          {config.subtitle}
                        </p>
                      )}
                      {config.ctaText && (
                        <button
                          ...
                          className="inline-flex items-center gap-2 px-6 py-3 bg-[#f78e2c] text-black font-bold font-heading uppercase tracking-widest text-sm rounded-full hover:bg-white transition-all duration-300 shadow-[0_0_20px_rgba(247,142,44,0.4)]"
                        >
                          {config.ctaText}
              ...
              {!config.image && (config.title || config.subtitle) && (
                <div className="relative w-full h-full rounded-2xl border border-white/10 p-8 md:p-12 flex flex-col justify-center items-center text-center bg-gradient-to-br from-[#15222e] to-[#0b1219] shadow-2xl shadow-[#f78e2c]/10">
                  {config.title && (
                  ...
                  {config.subtitle && (
                    <p className="text-xl md:text-2xl text-[#f78e2c] font-medium mb-8">
                      {config.subtitle}
                    </p>
                  )}
                  {config.ctaText && (
                    <button
                      onClick={handleCTAClick}
                      className="inline-flex items-center gap-2 px-8 py-4 bg-[#f78e2c] text-black font-bold font-heading uppercase tracking-widest rounded-full hover:bg-white transition-all duration-300 shadow-[0_0_30px_rgba(247,142,44,0.4)]"
                    >
                      {config.ctaText}
